        ...
        <div className="px-4 py-12">
          <div className="mx-auto flex justify-center">
            <div className="relative">
              <div className="h-[160px] w-[160px] rounded-full border border-fuchsia-400" />
              <div className="absolute top-2.5 right-2.5 h-[140px] w-[140px] rounded-full border border-fuchsia-400" />
              <div>
                <svg
